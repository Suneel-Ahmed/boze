        ...
        <div className='w-full text-white gap-y-[15px] flex min-h-fit  flex-col' >
            ...
            <div className='text-white text-lg max-lg:flex-col  max-lg:items-center flex justify-between' >
                ...
                <div className='flex items-center max-md:flex-col capitalize  max-lg:order-1 gap-3' >
                    ...
                    <Link className='max-sm:text-[14px]'  onClick={handleClick} to = {"/publicPolicy"}  >Public Policy</Link>
                    <Link className='max-sm:text-[14px]' onClick={handleClick} to = {"/whitePaper"}  >White Paper</Link>
                    <Link className='max-sm:text-[14px]' onClick={handleClick} to = {"/collab"}  >Collab with Us</Link>
                    </div>
