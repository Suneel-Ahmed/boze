      ...
      <div className="flex justify-between max-lg:justify-center items-center w-full px-[200px] gap-[100px]">
        ...
        <div className="flex gap-[80px] max-lg:mx-auto flex-col">
          <div className="flex flex-col me-auto max-lg:mx-auto max-lg:items-center max-lg:text-center items-start">
            <img src="/images/logo/5.png" alt="boze" className="w-[180px] " />
            <h1 className="text-[30px] text-white mt-4 ">Binance</h1>
            <p className="text-[18px] w-[300px] text-white/50">
              User name and Binance Identification Number is Necessary to claim
              your reward
            </p>
          </div>
          <div className="flex flex-col me-auto max-lg:mx-auto max-lg:items-center max-lg:text-center items-start">
            <img src="/images/logo/6.png" alt="boze" className="w-[80px]" />
            <h1 className="text-[30px] text-white mt-4 ">Bitget</h1>
            <p className="text-[18px] w-[300px] text-white/50">
          ...
          <div className="w-full">
            <div className="px-10 py-2 rounded-xl bg-slate-300">
              <span>Note:</span>{" "}
