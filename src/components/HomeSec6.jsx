...
const HomeSec6 = () => {
  return (
    <div className="w-full min-h-fit  flex justify-center py-[100px] px-[clamp(20px,4.3vw,150px)]">
      <div className="flex justify-between max-lg:justify-center items-center w-full px-[200px] max-xl:gap-[50px] gap-[100px]">
        <div className="max-lg:hidden  max-xl:min-w-[300px]  min-w-[380px] " >
          <img src="/images/mobile/4.png" className="w-[380px] " alt="" />
        </div>
        <div className="flex max-xl:gap-[20px] gap-[80px] max-lg:mx-auto flex-col">
          <div className="flex flex-col me-auto max-lg:mx-auto max-lg:items-center max-lg:text-center items-start">
            <img src="/images/logo/5.png" alt="Binance" className=" max-xl:w-[60px] w-[75px] " />
            <p className="text-[clamp(14px,5.5vw,18px)] max-xl:w-[400px] w-[300px] mt-4 text-white/50 capitalize ">
            Username and Binance Identification Number are Necessary to Claim Your Reward
            </p>
          </div>
          <div className="flex flex-col me-auto max-lg:mx-auto max-lg:items-center max-lg:text-center items-start">
            <img src="/images/logo/6.png" alt="Bitget" className="max-xl:w-[60px] w-[80px]" />
            <p className="text-[clamp(14px,5.5vw,18px)]  max-xl:w-[400px] w-[300px] mt-4 text-white/50 capitalize ">
