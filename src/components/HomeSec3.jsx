  ...
  return (
    <div className='w-full flex justify-center items-center px-[clamp(30px,18.3vw,500px)]  min-h-fit' >
        <div className='flex max-lg:flex-col max-lg:items-center max-lg:gap-[20px] max-lg:text-center  text-start h-full mx-auto  text-white justify-center w-full  gap-[80px]' >
                <div className={` ${!item ? "lg:order-1 max-lg:order-1" : "lg:order-2 max-lg:order-1" }`} >
                    <img src="/images/mobile/mobile.png" className='w-[clamp(200px,10.3vw,350px)]' alt="mobile" />
                </div>
               
                <div className={`flex  ${!item ? "order-2 max-lg:order-2" : "order-1 max-lg:order-2" } items-start my-auto flex-col gap-[10px]`} >
                <img src="/images/btn/btn.svg" className='w-[40px] h-auto' alt="mobile" />
                    <h1 className='text-[clamp(20px,5.2vw,40px)]' >Every crypto you need</h1>
